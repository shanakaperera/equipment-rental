...
use Modules\Core\Http\Livewire\WithInline;
...
{
    use WithPrefix, WithOptions, WithSwitch, WithHelp, WithModel, WithDisabled, WithInline;
    ...
    public function selectAll($flag)
    {
        $this->attrs['select-all'] = $flag;

        return $this;
    }

    public function hr($flag)
    {
        $this->attrs['hr'] = $flag;
    ...
    {
        return view('core::components.form.checkboxes');
    }
}
