...
// types (DRY)
    ...
    var _exportData = function ( dt, inOpts )
    {
        ...
        var another_table_col_print_index = config.another_table_col_print_index;
        var another_column_index_val = config.another_column_index_val;
        ...
        if ( !(grouped_array_index == undefined) ) { //don't run grouping logic if rows aren't grouped
            ...
            for (var i = 0, row_length = body.length; i < row_length; i++) {
                ...
                if (sGroup !== sLastGroup) {
                    ...
                    if (another_column_index_val) {
                        another_column_index_val = eval('(' + another_column_index_val + ')();');
                    }
                    ...
                    for (var $column_index = 0; $column_index < iColspan; $column_index++) {
                        ...
                        } else if (another_table_col_print_index && another_column_index_val &&
                            $column_index === another_table_col_print_index) {
                            table_data[$column_index] = another_column_index_val;
                        } else {
                ...
                another_column_index_val = config.another_column_index_val;
            }
        }
